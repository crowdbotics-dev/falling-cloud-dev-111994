"""
Django settings for falling_cloud_dev_111994 project.
...
ROOT_URLCONF = 'falling_cloud_dev_111994.urls'
...
WSGI_APPLICATION = 'falling_cloud_dev_111994.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_cloud_dev_111994 API",
    "DESCRIPTION": "API documentation for falling_cloud_dev_111994 App",
    "VERSION": "v1",
}
